...
<div class="d-flex justify-content-between mb-4">
    <h4>Quản lý dự án</h4>
     <a href="<?= url('admin/project/create.php') ?> " class="btn btn-primary btn-sm">Thêm mới</a>
</div>
  ...
  <?php if(is_array($data)): ?>
    ...
    <tr>
      ...
      <td class="text-center" style="width:50px">
        <a href="<?= url("admin/project/update.php?id=$item->id") ?>"><b class='badge badge-warning status-Content'>Sửa</b></a>
      </td>
      <td class="text-center" style="width:50px">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="<?= url("admin/project/delete.php?id=$item->id") ?>" class="btn btn-primary">Xóa</a>
              </div>
            </div>
          </div>
        </div>
