...
<head>
  <meta charset="utf-8">
  <title>Label - <?= isset($title) ? $title : '' ?></title>
      ...
      <ul class="navigation-menu">
        ...
        <li>
          ...
          <ul class="collapse navigation-submenu" id="sample-pages">
            <li>
              <a href="<?= url('admin/category-project') ?>">Loại dự án</a>
            </li>
            <li>
              <a href="<?= url('admin/project/') ?>">Dự án</a>
            </li>
          </ul>
        </li>
        <li>
...
>>>>>>> 7a0fc416a8f6e90a19a20039bc461189c12d1e73
...
<<<<<<< HEAD
          <a href="<?= url('admin/roles') ?>">
            <span class="link-title">Quản lý quyèn</span>
...
>>>>>>> 7a0fc416a8f6e90a19a20039bc461189c12d1e73
        ...
        <li>
          <a href="<?= url('admin/profile') ?>">
            <span class="link-title">Hồ sơ</span>
